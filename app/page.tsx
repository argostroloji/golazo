  ...
  return (
    <div className="wrap">
      <div className="topbar">
        <div className="brand">
          <img src="/icon.png" alt="Worldcup Cards" style={{ width: 32, height: 32, borderRadius: 8 }} />
      ...
      <div className="scroll">
        {view === "connect" && (
          <div className="hero">
            <div className="crest"><img src="/icon.png" alt="Worldcup Cards" style={{ width: 96, height: 96, borderRadius: 20 }} /></div>
